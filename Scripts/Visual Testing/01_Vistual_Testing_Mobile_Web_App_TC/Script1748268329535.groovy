...
WebUI.takeAreaScreenshotAsCheckpoint("Hongkong_Option_Selected", new Rectangle(0,100,200,400))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment'), 'abc')

WebUI.takeFullPageScreenshotAsCheckpoint('Full_Form_After_Updating')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/a_Go to Homepage'), 'Go to Homepage')

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_CURA Healthcare Service/a_Go to Homepage'))
